...
use tower::BoxError;
use tower::Service;
use tower::{Layer, ServiceExt, layer::layer_fn};
...
pub trait MakeServiceRef<Target, Request>: Sealed<(Target, Request)> {
    ...
    type Service: tower::Service<Request, Response = Self::Response, Error = Self::Error>;
...
where
    ...
    S: tower::Service<Request, Response = Response, Error = E>,
